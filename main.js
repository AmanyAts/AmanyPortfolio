     ...
     function showWebsite(event){
       ...
       if(id=='tic' || id=='tic1'){
        $('#img').html('')
        $('#img').prepend('<h3>Tic-tac-toe </h3><p>Tic-Tac-Toe game as front-end website,two players can play the user will be able to select the character X or O'+
           ' and there is a choice to play verse computer also the player score will counted</p>'+
           ' <a href="https://amanyats.github.io/Tic-Tac-Toe-project/">Demo</a>'+'<img class="mySlides" src="tic-tac-toe.PNG" style="width:100%"><img class="mySlides" src="tic2.PNG" style="width:100%"><img class="mySlides" src="tic 3.PNG" style="width:100%"><img class="mySlides" src="tic5.PNG" style="width:100%">')
        modal.style.display = "block";
        x=document.getElementsByClassName("mySlides");
       
       }else if(id=='trip'){
        $('#img').html('')
        $('#img').prepend( '<h3>Trip planner </h3><p>Trip planner website that helps you to build a custsmised plan so you can add a destinaation where you will go and add the places or the activites to the plan'+
       ...
       ' <img class="mySlidess"  src="trip6.PNG" style="width:100%">'+
        ...
        $('#img').html('')
        $('#img').prepend( '<h3>Currancy Exchange </h3>'+
